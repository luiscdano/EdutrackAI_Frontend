...
const Activities = ({ userId, onBack }: ActivitiesProps) => {
  ...
  return (
    <section className="flex w-full flex-col gap-6">
      ...
      {showForm && <ActivityForm key={editingSession?.id ?? "new-session"} subjects={subjects} initialSession={editingSession} saving={saving} onSubmit={handleSave} onCancel={() => { setEditingSession(null); setShowForm(false); }} />}
