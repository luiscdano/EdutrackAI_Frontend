...
- Inspect official institution → career → period → subject catalogs.
- Create a persistent institution from Admin.
- Add one or more careers/programs to that institution.
- Add curriculum subjects to a managed career; once it has subjects, it becomes available in registration/onboarding.
- Synchronize catalog subjects into operational subjects.
